...
function brandmodal(){
  $(document).on('click', '#brand', function (e) {
    ...
    document.getElementById("idjenisgaransi").value = $(this).attr('data-idjenisgaransi');
    document.getElementById("jenisgaransi").value = $(this).attr('data-jenisgaransi');
    document.getElementById("idperiodegaransi").value = $(this).attr('data-idperiodegaransi');
    document.getElementById("periodegaransi").value = $(this).attr('data-periodegaransi');
    document.getElementById("idclaimgaransi").value = $(this).attr('data-idclaimgaransi');
...
function matauangmodal(){
  $(document).on('click', '#matauang', function (e) {
    ...
    document.getElementById("symbolhargajual").value = $(this).attr('data-symbol');
    document.getElementById("symbolhargabeli").value = $(this).attr('data-symbol');
...
function selectinvoice(){
  $(document).on('click', '#datainvoice', function (e) {
    document.getElementById("nopembelian").value = $(this).attr('data-nomorpembelian');
    document.getElementById("idclientinvoice").value = $(this).attr('data-idclient');
    document.getElementById("invoice").value = $(this).attr('data-nomorapr');
    document.getElementById("tanggaljto").value = $(this).attr('data-tanggaljto');
    document.getElementById("matauanginvoice").value = $(this).attr('data-kodematauang');
    document.getElementById("idmatauanginvoice").value = $(this).attr('data-idmatauang');
    document.getElementById("rateinvoice").value = $(this).attr('data-rate'); 
    document.getElementById("totalpembelian").value = $(this).attr('data-total'); 
...
function coacashbankdetailmodal(){
  $(document).on('click', '#coacashbankdetail', function (e) {
    ...
    var namasubakuncashdetail = document.getElementById("namasubakuncashdetail").value
    var namacostcentersatu = document.getElementById("namacostcentersatu").value

    document.getElementById("keterangancashdetail").value = namaakun + "\n" + namasubakuncashdetail + "\n" + namacostcentersatu + "\n"
    if (namaakun != "" && namasubakuncashdetail != "" && namacostcentersatu != "") {
      document.getElementById("keterangancashdetail").value = namaakun + "\n" + namasubakuncashdetail + "\n" + namacostcentersatu + "\n" 
    }if(namaakun != "" && namasubakuncashdetail == "" && namacostcentersatu != ""){
      document.getElementById("keterangancashdetail").value =  namaakun + "\n"+ namacostcentersatu + "\n"
    }if (namaakun != "" && namasubakuncashdetail != "" && namacostcentersatu == "") {
      ...
      document.getElementById("keterangancashdetail").value =  namacostcentersatu + "\n"
    }
...
function subakuncashdetailmodal(){
  $(document).on('click', '#datasubakuncashdetail', function (e) {
    ...
    //console.log(tes)
    document.getElementById("subakuncashdetail").value = $(this).attr('data-subakun');
    document.getElementById("namasubakuncashdetail").value = $(this).attr('data-namasubakun');
...
function costcenterdetailmodal(){
  $(document).on('click', '#costcenterdetail', function (e) {
    ...
    document.getElementById("costcentersatu").value = $(this).attr('data-kodecostcenter');
    document.getElementById("namacostcentersatu").value = $(this).attr('data-namacostcenter');
...
function coacashbanklawanmodal(){
  $(document).on('click', '#coacashbanklawan', function (e) {
    ...
    var namasubakuncashlawan = document.getElementById("namasubakuncashlawan").value
    ...
    if (namaakun != "" && namasubakuncashlawan != "" && namacostcenterdua != "") {
      document.getElementById("keterangancashlawan").value = namaakun + "\n" + namasubakuncashlawan + "\n" + namacostcenterdua + "\n" 
    }if(namaakun != "" && namasubakuncashlawan == "" && namacostcenterdua != ""){
      document.getElementById("keterangancashlawan").value =  namaakun + "\n"+ namacostcenterdua + "\n"
    }if (namaakun != "" && namasubakuncashlawan != "" && namacostcenterdua == "") {
      ...
      document.getElementById("keterangancashlawan").value =  namacostcenterdua + "\n"
    }
...
function subakuncashlawanmodal(){
  $(document).on('click', '#datasubakuncashlawan', function (e) {
    ...
    document.getElementById("subakuncashlawan").value = $(this).attr('data-subakun');
    document.getElementById("namasubakuncashlawan").value = $(this).attr('data-namasubakun');
    var namaakun = document.getElementById("namaakundua").value
    var namasubakuncashlawan = document.getElementById("namasubakuncashlawan").value
    var namacostcenterdua = document.getElementById("namacostcenterdua").value
...
function costcenterlawanmodal(){
  $(document).on('click', '#costcenterlawan', function (e) {
    ...
    document.getElementById("costcenterdua").value = $(this).attr('data-kodecostcenter');
    document.getElementById("namacostcenterdua").value = $(this).attr('data-namacostcenter');
...
function lawantransaksimodal(){
  $(document).on('click', '#lawantransaksimodal', function (e) {
    document.getElementById("lawantransaksi").value = $(this).attr('data-namaclient');
...
//   $(document).on('click', '#baranginventory', function (e) { 
//     document.querySelector(`tr#${parentNode.parentNode.parentNode.id} input[name=skuproduk]`).value = $(this).attr('data-skuproduk'); 
...
function finishingmodalspk(){
  $(document).on('click', '#finishingspk', function (e) {
     var id = $("#id").val();
    document.querySelector(`#detail${id} #idfinishing`).value = $(this).attr('data-id');
    document.querySelector(`#detail${id} #finishing`).value = $(this).attr('data-finishing'); 
...
function warnaprodukmodalspk(){
  ...
  document.querySelector(`#detail${id} #idwarnaproduk`).value = $(this).attr('data-id');
...
function modalbarangjadi(){
  $(document).on('click', '#barangjadimodal', function (e) {
    ...
    document.getElementById("lokasibarangjadi").value = $(this).attr('data-lokasibarangjadi'); 
    document.getElementById("idbarangjadi").value = $(this).attr('data-idbarangjadi'); 
    document.getElementById("model").value = $(this).attr('data-model'); 
    document.getElementById("hargasales").value = $(this).attr('data-hargasales'); 
    document.getElementById("iddetaildesain").value = $(this).attr('data-iddetaildesain'); 
...
function produkjadimodal(){
  $(document).on('click', '#produkjadi', function (e) {
    ...
    document.getElementById("namaprodukjadi").value = $(this).attr('data-produk'); 
