...
<div class="modal fade" id="modalreport" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h3>Cetak Data Service</h3>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
               <span aria-hidden="true">×</span>
            </button>
         </div>
         <form action="<?php echo base_url() . 'report/printdataservice'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true" target="_Blank">
            <div class="modal-body">
               <div class="row" style="margin-bottom: 20px;">
                  <div class="col-md-6">
                     <label class="bmd-label-floating">Dari Tanggal</label>
                     <input style="padding-bottom: 10px;max-width: 250px;" value="<?php echo date('Y-m-d', strtotime('first day of m')) ?>" type="date" name="from" id="from" class="form-control">
                  </div>
                  <div class="col-md-6">
                     <label class="bmd-label-floating">Sampai Tanggal</label>
                     <input style="padding-bottom: 10px;max-width: 250px;" value="<?php echo date('Y-m-d', strtotime('last day of m')); ?>" type="date" name="to" id="to" class="form-control" onblur="validasiprintstockmutation()">
                  </div>
               </div>
            </div>
            <div class="modal-footer">
               <button style=" text-align: right;" type="submit" class="btn btn-primary btn-flat"><i class="fas fa-fw fa-print"></i> <?php echo $this->lang->line('print'); ?></button>
            </div>
         </form>
      </div>
   </div>
