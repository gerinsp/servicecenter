      ...
      <div class="container-fluid" style="padding-bottom: 70px;">
         ...
         <div class="shadow card">
            ...
            <div class="card-body">
               ...
               <form action="<?php echo base_url() . 'tambahdataadmin'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input style="padding-bottom: 10px;" type="text" required name="namaadmin" class="form-control" value="<?= set_value('namaadmin') ?>">
