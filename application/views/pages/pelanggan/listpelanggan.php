                           ...
                           <tbody>
                              ...
                              ?>
                                 <tr id="pelanggan<?= $data->id_pelanggan ?>">
                                    ...
                                    <td style="vertical-align: top;border-top: 1px solid #e3e6f0;" width="20%">
                                       <a style="margin-bottom: 10px; width:80px" href="<?= base_url('editdatapelanggan/' . str_replace(array('=', '+', '/'), '', $this->encrypt->encode($data->id_pelanggan))); ?>" class="btn btn-sm btn-success" role="button" title="Ubah"><i class="fas fa-fw fa-pencil-alt"></i> <?php echo $this->lang->line('change'); ?> </a><br>
                                       <a style="margin-bottom: 10px; width:80px" href="#" data-toggle="modal" data-target="#deleteModal" data-id="<?= str_replace(array('=', '+', '/'), '', $this->encrypt->encode($data->id_pelanggan)) ?>" class="btn btn-sm btnOpenDeleteModal btn-danger mr-1" title="Hapus" onclick="openDeleteModal(this, 'Pelanggan/deletePelanggan')" class="btn btn-sm btn-danger" role="button" title="Hapus"> <i class="fas fa-fw fa-trash"></i> <?php echo $this->lang->line('delete'); ?> </a><br>
                                       <a style="margin-bottom: 10px; width:80px" href="<?= base_url('detaildatapelanggan/' . str_replace(array('=', '+', '/'), '', $this->encrypt->encode($data->id_pelanggan))); ?>" class="btn btn-sm btn-primary" role="button" title="Detail"><i class="fas fa-fw fa-search"></i> Detail </a>
                                    </td>
                                 </tr>
                              <?php
                                 $no++;
