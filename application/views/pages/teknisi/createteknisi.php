      ...
      <div class="container-fluid" style="padding-bottom: 70px;">
         ...
         <div class="shadow card">
            ...
            <div class="card-body">
               ...
               <form action="<?php echo base_url() . 'tambahdatateknisi'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input style="padding-bottom: 10px;" type="text" required name="namateknisi" class="form-control" value="<?= set_value('namateknisi') ?>">
                           <?= form_error('namateknisi', '<small class="text-danger">', '</small>'); ?>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <div class="form-group">
                           <label class="bmd-label-floating">Telepon <small class="text-danger">*</small></label>
                           <input style="padding-bottom: 10px;" type="number" required name="telepon" class="form-control" value="<?= set_value('telepon') ?>">
