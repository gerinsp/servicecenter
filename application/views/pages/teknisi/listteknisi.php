         ...
         <div class="row">
            <div class="col-12">
               ...
               <div class="shadow card">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                     <h6 class="m-0 font-weight-bold text-primary"> <a class="text-info" style="text-decoration: none;" class="collapse-item" href="<?php echo base_url() ?>tambahdatateknisi"> <i class="fas fa-fw fa-plus text-info"></i> <?php echo $this->lang->line('add'); ?> Data Teknisi</h6></a>
                     <br>
                        ...
                        <table style="border-collapse: 1;color: #858796;border-bottom: 2px solid #e3e6f0;" class="table tablelist table-bordered table-striped" width="100%" height="1px" cellspacing="0">
                           <thead>
                              <tr height="20px">
                                 ...
                                 <th style=" padding: 0.75rem;vertical-align: top;border-top: 1px solid #e3e6f0;">Nama teknisi</th>
                              ...
                              ?>
                                 <tr id="teknisi<?= $data->id_teknisi ?>">
                                    ...
                                    <td style="vertical-align: top;border-top: 1px solid #e3e6f0;" width="20%">
                                       <a style="margin-bottom: 10px; width:80px" href="<?= base_url('editdatateknisi/' . str_replace(array('=', '+', '/'), '', $this->encrypt->encode($data->id_teknisi))); ?>" class="btn btn-sm btn-success" role="button" title="Ubah"><i class="fas fa-fw fa-pencil-alt"></i> <?php echo $this->lang->line('change'); ?> </a>
                                       <a style="margin-bottom: 10px; width:80px" href="#" data-toggle="modal" data-target="#deleteModal" data-id="<?= str_replace(array('=', '+', '/'), '', $this->encrypt->encode($data->id_teknisi)) ?>" class="btn btn-sm btnOpenDeleteModal btn-danger mr-1" title="Hapus" onclick="openDeleteModal(this, 'teknisi/deleteteknisi')" class="btn btn-sm btn-danger" role="button" title="Hapus"> <i class="fas fa-fw fa-trash"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                    </td>
                                 </tr>
                              <?php
                                 $no++;
